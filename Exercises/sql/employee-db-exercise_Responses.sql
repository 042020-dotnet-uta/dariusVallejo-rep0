...
ADD CONSTRAINT FK_EmpDetailsID
FOREIGN KEY (EmployeeID)
REFERENCES EmployeeB (ID)
ON DELETE NO ACTION
ON UPDATE NO ACTION;

CREATE INDEX IFK_EmpDetailsID ON EmpDetails (EmployeeID);
...
CREATE INDEX IFK_EmployeeDeptID ON EmployeeB (DeptID);
